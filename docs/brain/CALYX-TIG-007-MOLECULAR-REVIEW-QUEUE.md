...
The next UI/API step is an owner-authenticated review-console endpoint built over the same query service. That should expose queue reads and the existing explicit review action without adding any automatic acceptance or publication behavior.
