...
Current-main implementation candidate. No deployment, publication, credential access, or production Knowledge Graph mutation occurs in this build.
...
Focused tests cover deterministic ordering under reversed input order, prerequisite waiting versus failure, successful dependency release, capacity ordering, architecture/role/repository limits, and invalid dependency graphs. The focused workflow validates BUILD-BRAIN-108 through BUILD-BRAIN-110 together against current `main`.
