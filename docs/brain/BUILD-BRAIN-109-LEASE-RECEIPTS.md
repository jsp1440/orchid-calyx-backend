...
Focused tests cover delivered receipt completion, dependency release, receipt identity mismatch, cancellation receipt persistence, stale replay rejection, and timeout classification. The BUILD-BRAIN-108 workflow validates BUILD-BRAIN-108 and BUILD-BRAIN-109 together against current `main`.
