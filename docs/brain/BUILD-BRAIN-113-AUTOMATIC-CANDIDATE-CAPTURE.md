...
Implemented as an atomic candidate-capture contract on current `main`. This build does not publish, deploy, activate taxonomy, or mutate the production Knowledge Graph.
...
- deterministic Mission Control capture-status projection;
