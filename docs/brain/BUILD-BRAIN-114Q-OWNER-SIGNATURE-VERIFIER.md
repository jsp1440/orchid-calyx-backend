...
This R2 rebuild is stacked directly on BUILD-BRAIN-114O-R2 PR #753, preserving the strengthened chain through #696 → #747 → #749 → #753.
...
- canonical assignment-input checksum verification at the 114M-R1 root;
