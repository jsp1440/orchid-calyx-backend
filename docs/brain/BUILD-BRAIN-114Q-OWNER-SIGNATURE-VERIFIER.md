...
R4 reconstruction directly on BUILD-BRAIN-114O-R4 PR #775, rooted in the hardened 114M-R2 trust chain through #771 and #773. Draft and unmerged pending executable CI.
...
`#761 BUILD-BRAIN-114M-R2 → #771 BUILD-BRAIN-114N-R4 → #773 BUILD-BRAIN-114P-R4 → #775 BUILD-BRAIN-114O-R4 → this BUILD-BRAIN-114Q-R4`.

The chain preserves manifest v2, request v2, durable `patch_program_job_id`, canonical assignment-input checksum verification, explicit durable mutation intent before workspace-write capability, exact patch input/output agreement, durable independent reviews, and verifier-only owner authorization.
...
BUILD-BRAIN-114R may be rebuilt directly on this exact R4 head as a deterministic plan-only layer. Actual repository mutation remains a separate owner-governance decision.
