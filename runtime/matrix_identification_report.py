        ...
        "reports": [
            {
                ...
                "session_revision": (item.get("core") or {}).get("session_revision"),
                "registry": (item.get("core") or {}).get("registry"),
                "leading_candidate": (
                    (((item.get("core") or {}).get("ranking") or {}).get("candidates") or [{}])[0].get(
                        "scientific_name"
                    )
                    if (((item.get("core") or {}).get("ranking") or {}).get("candidates") or [])
                    else None
                ),
            }
