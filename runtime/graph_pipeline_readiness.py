...
DOMAIN_DEFINITIONS: dict[str, dict[str, Any]] = {
    "taxonomy": {
        ...
        "components": [
            ...
            "runtime.knowledge_graph.taxonomy_staging_pipeline.TaxonomyStagingPipeline",
        ...
        "capabilities": {
            ...
            "provenance": "implemented_with_release_id_checksum_version_acquired_at",
            "staging_graph_projection": "implemented_sqlite_bounded_resumable",
            "publication_readiness": "blocked_pending_owner_promotion_approval",
            "freshness_or_checkpoint_monitoring": "implemented_resumable_checkpoint",
    ...
    "occurrences": {
        ...
        "components": [
            ...
            "app.harvest.durable_persistence.DurableSqliteHarvestPersistence",
            "app.harvest.durable_checkpoints.DurableSqliteCheckpointStore",
            "runtime.knowledge_graph.occurrence_reconciler.OccurrenceCanonicalReconciler",
        ...
        "capabilities": {
            "source_ingestion": "implemented_bounded", "raw_persistence": "implemented_durable_sqlite",
            "normalization": "implemented", "taxonomic_reconciliation": "implemented_canonical_crosswalk",
            "provenance": "implemented_with_canonical_taxon_id",
            "staging_graph_projection": "registered",
            "publication_readiness": "blocked_pending_staging_graph_write",
            "freshness_or_checkpoint_monitoring": "implemented_durable_sqlite_checkpoint",
            "mission_control_visibility": "telemetry_only",
        },
        "blockers": [
            "Durable staging graph write path from occurrence records to oc_atlas.occurrences is not yet implemented.",
        ],
