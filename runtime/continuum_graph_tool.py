...
CALYX-635 exposes graph traversal to conversation without granting publication or
mutation authority. The adapter accepts the existing read-only graph repository
contract and returns an explicit status envelope rather than inventing graph facts
when the database or focal taxon is unavailable.
"""
