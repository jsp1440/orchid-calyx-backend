...
class HarvesterControlPlane:
    ...
    def resume(self, harvester_id: str, actor: str) -> dict[str, Any]:
        return {"status": "active", "harvester": self.serialize_harvester(self._transition(harvester_id, "active", actor, "resume", risk="low"))}
    ...
    def propose_target_change(self, harvester_id: str, proposed: dict[str, Any], rationale: str) -> dict[str, Any]:
        ...
        harvester.updated_at = utc_now()
        return {"status": "pending", "proposal": asdict(proposal), "harvester": self.serialize_harvester(harvester)}
    ...
    def serialize_harvester(self, harvester: Harvester) -> dict[str, Any]:
        ...
        data["changeTarget"] = "requires_owner_authorization"
        data["changeSchedule"] = "requires_owner_authorization"
        data["retire"] = "requires_owner_authorization"
        data["approveRecommendation"] = "requires_owner_authorization"
        data["rejectRecommendation"] = "requires_owner_authorization"
        data["reassess"] = "requires_owner_authorization"
