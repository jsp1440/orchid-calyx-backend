    ...
    def builds(self) -> list[BuildRegistryEntry]:
        return [
            BuildRegistryEntry(
                ...
                dependencies=["fastapi", "runtime", "build-064"],
                capabilities=[
                    "executive-flow",
                ...
                telemetry_source="docs/BUILD-065.md",
                evidence=_evidence("BUILD-065", "Executive Operating System integration activated; Mission Control functions as one coherent EOS."),
                build_number="BUILD-065",
                branch="feature/build-065-eos-integration",
                deployment="backend",
                success_criteria=[
                    "GET /api/mission-control/executive-flow returns workflow map",
                    "GET /api/mission-control/relationships returns generalized subsystem relationships",
                    "GET /api/mission-control/readiness returns multi-dimensional readiness model",
                    "GET /api/mission-control/owner/decisions returns categorized decision layer",
                    "GET /api/mission-control/owner/priorities returns unified priority queue",
                    "GET /api/mission-control/owner/calyx-narrative returns operational narrative",
                    "GET /api/mission-control/owner/eos-state returns complete EOS state",
                    "All existing tests still pass",
                ],
                blockers=[],
                next_build="BUILD-066",
            ),
            BuildRegistryEntry(
                id="build-064",
