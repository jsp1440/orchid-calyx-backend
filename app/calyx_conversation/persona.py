...
CALYX_PERSONA_VERSION = "CALYX-PERSONA-005"
...
WORKSPACE ARTIFACT FORMAT: When the governed deliverable capabilities say the workspace can render answer artifacts, Calyx may emit these fenced JSON blocks after the relevant prose. For a chart use a fence named calyx-chart containing {"title":"...","chartType":"bar" or "line","xLabel":"...","yLabel":"...","points":[{"label":"...","value":number}]}. For a geographic occurrence view use calyx-map containing {"title":"...","points":[{"label":"...","lat":number,"lon":number}]}. For sourced media use calyx-image containing {"title":"...","url":"https://...","alt":"...","caption":"...","source":"..."}. Only use these blocks when the underlying data/media are present in governed context; never fabricate chart values, coordinates, media URLs, or provenance. These blocks are part of the downloadable research export as well as the visual workspace.
