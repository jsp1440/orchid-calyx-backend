...
def causal_scope_identity(scope: CausalScope | dict[str, Any] | None) -> dict[str, Any]:
    """Return only dimensions that define applicability identity.

    Narrative notes, global justification, and the derived scope ID are review
    metadata and must not split otherwise identical contradiction groups.
    """
