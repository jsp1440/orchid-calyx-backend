...
DOMAIN_TERMS: dict[DesignDomain, tuple[str, ...]] = {
    ...
    DesignDomain.INFORMATION_ARCHITECTURE: (
        "information architecture",
        "navigation",
        "taxonomy",
    ),
    DesignDomain.INTERACTION_DESIGN: ("interaction design", "affordance", "feedback"),
    DesignDomain.DASHBOARD_DESIGN: (
        "dashboard",
        "status display",
        "key performance indicator",
    ),
    DesignDomain.ACCESSIBILITY: (
        "accessibility",
        "wcag",
        "screen reader",
        "contrast",
    ...
    DesignDomain.MOTION_AND_ANIMATION: (
        "motion design",
        "animation",
        "transition",
        "reduced motion",
    ),
    DesignDomain.EDUCATIONAL_DESIGN: (
        "instructional design",
        "educational design",
        "lesson",
    ),
    DesignDomain.LEARNING_SCIENCES: (
        "mayer",
        "multimedia learning",
        "cognitive load",
        "learning science",
    ),
    DesignDomain.SCIENTIFIC_VISUALIZATION: (
        "scientific visualization",
        "data visualization",
        "uncertainty visualization",
    ),
    DesignDomain.BRANDING_AND_VISUAL_IDENTITY: (
        "branding",
        "visual identity",
        "brand system",
    ),
    DesignDomain.DESIGN_SYSTEMS: ("design system", "design token", "style guide"),
    DesignDomain.COMPONENT_LIBRARIES: (
        "component library",
        "component api",
        "storybook",
    ),
...
TYPE_TERMS: dict[DesignKnowledgeType, tuple[str, ...]] = {
    ...
    DesignKnowledgeType.EDUCATIONAL_THEORY: (
        "theory",
        "multimedia learning",
        "cognitive load",
    ),
    DesignKnowledgeType.ACCESSIBILITY_REQUIREMENT: (
        "wcag",
        "accessibility requirement",
        "success criterion",
    ),
    DesignKnowledgeType.VISUALIZATION_TECHNIQUE: ("visualization", "chart", "encoding"),
    DesignKnowledgeType.INTERACTION_PATTERN: (
        "interaction pattern",
        "affordance",
        "interaction",
    ),
...
def classify(
    ...
    tuple[DesignDomain, ...], tuple[DesignKnowledgeType, ...], float, tuple[str, ...]
]:
    ...
    domains = set(requested_domains) | {
        key for key, hits in domain_hits.items() if hits
    }
