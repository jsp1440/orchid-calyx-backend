...
class AgentBehaviorLedger:
    """Append-only safe behavioral record.

    It intentionally accepts no raw prompts, tool arguments, credentials,
    environment values, or model chain-of-thought. The ledger captures declared
    intent, decisions, resources, tools, and outcomes only.
    """
