...
JOURNAL_SCHEMA = "calyx-git-proposal-mutation-journal-event-v2"
TERMINAL_STATUSES = frozenset(
    {"completed", "completed_subset", "partial_failure", "failed"}
)
ALLOWED_STATUSES = TERMINAL_STATUSES | {"in_progress"}
...
class DurableGitProposalMutationJournal:
    """Append-only, tamper-checked 114S receipt journal for restart recovery."""
