...
class IsolatedWorkspacePatchExecutor:
    ...
    This executor cannot create branches, commit, invoke Git, run validation commands,
    access the network, read credentials, merge, deploy, publish, or touch production
    scientific state. It only applies preimage-bound UTF-8 replacements to allowlisted
    paths inside a pre-created isolated worktree.
    """
