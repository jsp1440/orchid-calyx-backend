...
# Gated in tests/conftest.py by a real connection probe (TEST_DATABASE_URL, then
# DATABASE_URL); postgres_validation() connects for real, so presence alone is
# not evidence of a usable database.
