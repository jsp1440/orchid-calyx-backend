...
def test_graph_preview_uses_synthetic_provenance_not_candidate_table_identity():
    ...
    for node in result["graph_preview"]["nodes"]:
        assert node["provenance"]["source_table"] == "synthetic.mechanistic_candidate_preview"
    ...
    assert edge["provenance"]["source_table"] == "synthetic.mechanistic_candidate_preview"
