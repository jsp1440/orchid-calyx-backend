...
def payload(relationship: str, *, tissue: str = "young leaf") -> MechanisticCandidateRequest:
...
def test_different_experimental_scope_does_not_create_false_contradiction():
    repository, service = components()
    handoff_mechanistic_candidate(payload("promotes", tissue="young leaf"), (repository, service))
    handoff_mechanistic_candidate(payload("inhibits", tissue="root apex"), (repository, service))
