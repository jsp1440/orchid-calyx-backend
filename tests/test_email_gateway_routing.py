...
def envelope(*, recipients=("unknown@orchidcontinuum.org",), sender="person@example.org", subject="Hello"):
...
def test_existing_twin_direct_collection_contract_remains_compatible():
    decision = route_inbound_email(
        envelope(
