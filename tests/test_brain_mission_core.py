...
def test_live_existing_services_advance_to_ledger_without_aggregate_blocker():
    facts = [
        {"kind": "TAXON", "subject": "Laelia anceps", "predicate": "accepted_name", "object_value": "Laelia anceps", "confidence": 0.82},
        {"kind": "GEOGRAPHIC_OCCURRENCE", "subject": "Laelia anceps", "predicate": "occurs_in", "object_value": "Mexico", "confidence": 0.82},
        {"kind": "ECOLOGICAL_RELATIONSHIP", "subject": "Laelia anceps", "predicate": "pollinated_by", "object_value": "documented bee visitor", "confidence": 0.82},
        {"kind": "CONSERVATION_ASSERTION", "subject": "Laelia anceps", "predicate": "conservation_concern", "object_value": "habitat loss", "confidence": 0.82},
        {"kind": "ECOLOGICAL_RELATIONSHIP", "subject": "Laelia anceps", "predicate": "mycorrhizal_association", "object_value": "documented fungal association", "confidence": 0.82},
        {"kind": "GEOGRAPHIC_OCCURRENCE", "subject": "Laelia anceps", "predicate": "occurs_in", "object_value": "Mexico and Guatemala", "confidence": 0.78},
    ]
    ...
    assert result["state"] == "AWAITING_HUMAN_REVIEW"
    assert not any(item["code"] == "AGGREGATE_COMPONENT_UNAVAILABLE" for item in result["blockers"])
    ...
    assert result["reasoning_ledger"]["ledger_id"] == "b51e4fd5-4ebf-5a37-9ef3-ea53c11c8b28"
